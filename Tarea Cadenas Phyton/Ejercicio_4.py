...
numero_de_telefono = input(
    " Introduce tu numero telefonico usando el formato prefijo-numero-extension ")
print(" Tu numero de telefono sin prefijo y extension es ",
      numero_de_telefono[4:-3])
